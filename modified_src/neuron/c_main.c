// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/c_main.c
...
static void c_main_store_provenance_data(address_t provenance_region) {
    log_mini_debug("%u", 9000);  /* log_debug("writing other provenance data");*/
    ...
    log_mini_debug("%u", 9001);  /* log_debug("finished other provenance data");*/
}
...
static bool initialise(void) {
    log_mini_debug("%u", 9002);  /* log_debug("Initialise: started");*/
    ...
    log_mini_info("%u", 9003);  /* log_info("initialising the bit field region");*/
    ...
    log_mini_debug("%u", 9004);  /* log_debug("Initialise: finished");*/
    return true;
}
...
void resume_callback(void) {
    ...
    if (!neuron_resume(
            data_specification_get_region(NEURON_PARAMS_REGION, ds_regions))) {
        log_mini_error("%u", 9005);  /* log_error("failed to resume neuron.");*/
        rt_error(RTE_SWERR);
    }
...
void timer_callback(uint timer_count, uint unused) {
    ...
    log_mini_debug("%u%u", 9006,  time);  /* log_debug("Timer tick %u \n", time);*/
    ...
    if (infinite_run != TRUE && time >= simulation_ticks) {
        ...
        log_mini_debug("%u", 9007);  /* log_debug("Completed a run");*/
        ...
        log_mini_debug("%u%d", 9008,  count_rewire_attempts);  /* log_debug("Rewire tries = %d", count_rewire_attempts);*/
...
void c_main(void) {
    ...
    log_mini_debug("%u%d", 9009, timer_period);
