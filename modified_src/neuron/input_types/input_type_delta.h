// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/input_types/input_type_delta.h
...
static inline void input_type_convert_excitatory_input_to_current(
   ...
   log_mini_info("%u%12.6k%x", 9057,  exc_input, float_to_int(input_type->scale_factor));  /* log_info("exc_input: %12.6k, input_type->scale_factor: %f", exc_input,input_type->scale_factor);*/
