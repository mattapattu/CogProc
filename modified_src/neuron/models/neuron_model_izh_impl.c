...
static inline void neuron_ode(
    ...
    log_mini_debug("%u%9.4k%9.4k%9.4k%9.4k", 9122,  stateVar[1], neuron->V,  stateVar[2],  neuron->U);
...
void neuron_model_print_state_variables(const neuron_t *neuron) {
    log_mini_debug("%u%11.4k", 9123,  neuron->V);  /* log_debug("V = %11.4k ", neuron->V);*/
    log_mini_debug("%u%11.4k", 9124,  neuron->U);  /* log_debug("U = %11.4k ", neuron->U);*/
}

void neuron_model_print_parameters(const neuron_t *neuron) {
    log_mini_debug("%u%11.4k", 9125,  neuron->A);  /* log_debug("A = %11.4k ", neuron->A);*/
    log_mini_debug("%u%11.4k", 9126,  neuron->B);  /* log_debug("B = %11.4k ", neuron->B);*/
    log_mini_debug("%u%11.4k", 9127,  neuron->C);  /* log_debug("C = %11.4k ", neuron->C);*/
    log_mini_debug("%u%11.4k", 9128,  neuron->D);  /* log_debug("D = %11.4k ", neuron->D);*/

    log_mini_debug("%u%11.4k", 9129,  neuron->I_offset);  /* log_debug("I = %11.4k \n", neuron->I_offset);*/
}
