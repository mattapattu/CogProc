// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_nearest_pair_impl.c
...
address_t timing_initialise(address_t address) {
    log_mini_info("%u", 9215);  /* log_info("timing_initialise: starting");*/
    log_mini_info("%u", 9216);  /* log_info("\tSTDP nearest-pair rule");*/
    ...
    log_mini_info("%u", 9217);  /* log_info("timing_initialise: completed successfully");*/
    return lut_address;
}
