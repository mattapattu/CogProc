// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_recurrent_dual_fsm_impl.c
...
uint32_t *timing_initialise(address_t address) {
    log_mini_info("%u", 9258);  /* log_info("timing_initialise: starting");*/
    log_mini_info("%u", 9259);  /* log_info("\tRecurrent dual-FSM STDP rule");*/
    ...
    log_mini_info("%u%d%d", 9260, plasticity_trace_region_data.accumulator_depression_plus_one - 1, plasticity_trace_region_data.accumulator_potentiation_minus_one + 1);
    ...
    log_mini_info("%u", 9261);  /* log_info("timing_initialise: completed successfully");*/
