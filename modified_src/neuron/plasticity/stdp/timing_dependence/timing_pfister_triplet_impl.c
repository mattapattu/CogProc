// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_pfister_triplet_impl.c
...
address_t timing_initialise(address_t address) {
    log_mini_info("%u", 9212);  /* log_info("timing_initialise: starting");*/
    log_mini_info("%u", 9213);  /* log_info("\tSTDP triplet rule");*/
    ...
    log_mini_info("%u", 9214);  /* log_info("timing_initialise: completed successfully");*/
