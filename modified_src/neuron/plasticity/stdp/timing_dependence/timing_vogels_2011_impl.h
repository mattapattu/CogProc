// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_vogels_2011_impl.h
...
static inline int16_t timing_add_spike(
    ...
    log_mini_debug("%u%d%d", 9262,  delta_time,  new_trace);  /* log_debug("\tdelta_time=%d, new_trace=%d\n", delta_time, new_trace);*/
...
static inline update_state_t timing_apply_pre_spike(
    ...
    log_mini_debug("%u%u%d", 9263, time_since_last_post,  decayed_o1);
...
static inline update_state_t timing_apply_post_spike(
    ...
    log_mini_debug("%u%u%d", 9264, time_since_last_pre,  decayed_r1);
