...
address_t timing_initialise(address_t address) {
    log_mini_debug("%u", 9218);  /* log_debug("timing_initialise: starting");*/
    log_mini_debug("%u", 9219);  /* log_debug("\tRecurrent pre-calculated stochastic STDP rule");*/
    ...
    log_mini_debug("%u%d%d", 9220, plasticity_trace_region_data.accumulator_depression_plus_one - 1, plasticity_trace_region_data.accumulator_potentiation_minus_one + 1);
    /* log_debug("\tAccumulator depression=%d, Accumulator potentiation=%d",plasticity_trace_region_data.accumulator_depression_plus_one - 1,plasticity_trace_region_data.accumulator_potentiation_minus_one + 1);*/
    ...
    log_mini_debug("%u", 9221);  /* log_debug("timing_initialise: completed successfully");*/
