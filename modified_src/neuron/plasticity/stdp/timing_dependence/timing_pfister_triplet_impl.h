// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_pfister_triplet_impl.h
...
static inline post_trace_t timing_add_post_spike(
    ...
    log_mini_debug("%u%d%d%d", 9265,  delta_time,  new_o1,  new_o2);  /* log_debug("\tdelta_time=%d, o1=%d, o2=%d\n", delta_time, new_o1, new_o2);*/
...
static inline pre_trace_t timing_add_pre_spike(
    ...
    log_mini_debug("%u%u%d%d", 9266,  delta_time,  new_r1,  new_r2);  /* log_debug("\tdelta_time=%u, r1=%d, r2=%d\n", delta_time, new_r1, new_r2);*/
...
static inline update_state_t timing_apply_pre_spike(
    ...
    log_mini_debug("%u%u%d%d%d", 9267, time_since_last_post,  decayed_o1,  trace.r2,  decayed_o1_r2);
    /* log_debug("\t\t\ttime_since_last_post_event=%u, decayed_o1=%d, r2=%d,decayed_o1_r2=%d\n",time_since_last_post, decayed_o1, trace.r2, decayed_o1_r2);*/
...
static inline update_state_t timing_apply_post_spike(
    ...
    if (time_since_last_pre > 0) {
        ...
        log_mini_debug("%u%u%d%d%d", 9268, time_since_last_pre,  decayed_r1,  trace.o2,  decayed_r1_o2);
        /* log_debug("\t\t\ttime_since_last_pre_event=%u, decayed_r1=%d, o2=%d,decayed_r1_o2=%d\n",time_since_last_pre, decayed_r1, trace.o2, decayed_r1_o2);*/
