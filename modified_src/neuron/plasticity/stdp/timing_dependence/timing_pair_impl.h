// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_pair_impl.h
...
static inline post_trace_t timing_add_post_spike(
    ...
    log_mini_debug("%u%d%d", 9233,  delta_time,  new_o1_trace);  /* log_debug("\tdelta_time=%d, o1=%d\n", delta_time, new_o1_trace);*/
...
static inline pre_trace_t timing_add_pre_spike(
    ...
    log_mini_debug("%u%u%d", 9234,  delta_time,  new_r1_trace);  /* log_debug("\tdelta_time=%u, r1=%d\n", delta_time, new_r1_trace);*/
...
static inline update_state_t timing_apply_pre_spike(
    ...
    log_mini_debug("%u%u%d", 9235, time_since_last_post,  decayed_o1);
...
static inline update_state_t timing_apply_post_spike(
    ...
    if (time_since_last_pre > 0) {
        ...
        log_mini_debug("%u%u%d", 9236, time_since_last_pre,  decayed_r1);
