// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_recurrent_dual_fsm_impl.h
...
static inline post_trace_t timing_add_post_spike(
    ...
    log_mini_debug("%u%d%u", 9225, random,  window_length);
    /* log_debug("\t\tResetting post-window: random=%d, window_length=%u",random, window_length);*/
...
static inline pre_trace_t timing_add_pre_spike(
    ...
    log_mini_debug("%u%d%u", 9226, random,  window_length);
    /* log_debug("\t\tResetting pre-window: random=%d, window_length=%u",random, window_length);*/
...
static inline update_state_t timing_apply_pre_spike(
    ...
    log_mini_debug("%u%u%u", 9227, time_since_last_post,  last_post_trace);
    /* log_debug("\t\t\ttime_since_last_post:%u, post_window_length:%u",time_since_last_post, last_post_trace);*/
...
static inline update_state_t timing_apply_post_spike(
    ...
    log_mini_debug("%u%u%u", 9230, time_since_last_pre,  last_pre_trace);
    /* log_debug("\t\t\ttime_since_last_pre:%u, pre_window_length:%u",time_since_last_pre, last_pre_trace);*/
