// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_recurrent_pre_stochastic_impl.h
...
static inline update_state_t timing_recurrent_calculate_pre_window(
    ...
    log_mini_debug("%u%d%u", 9210, random,  previous_state.window_length);
    /* log_debug("\t\tRandom=%d, Exp dist=%u",random, previous_state.window_length);*/
...
static inline update_state_t timing_recurrent_calculate_post_window(
    ...
    log_mini_debug("%u%d%u", 9211, random,  previous_state.window_length);
    /* log_debug("\t\tRandom=%d, Exp dist=%u",random, previous_state.window_length);*/
