...
address_t timing_initialise(address_t address) {
    log_mini_debug("%u", 9222);  /* log_debug("timing_initialise: starting");*/
    log_mini_debug("%u", 9223);  /* log_debug("\tSTDP pair rule");*/
    ...
    log_mini_debug("%u", 9224);  /* log_debug("timing_initialise: completed successfully");*/
