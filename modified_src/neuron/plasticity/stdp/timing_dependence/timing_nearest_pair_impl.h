// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_nearest_pair_impl.h
...
static inline post_trace_t timing_add_post_spike(
    ...
    log_mini_debug("%u%u", 9269,  time - last_time);  /* log_debug("\tdelta_time=%u\n", time - last_time);*/
...
static inline pre_trace_t timing_add_pre_spike(
    ...
    log_mini_debug("%u%u", 9270,  time - last_time);  /* log_debug("\tdelta_time=%u\n", time - last_time);*/
...
static inline update_state_t timing_apply_pre_spike(
    ...
    log_mini_debug("%u%u%d", 9271, time_since_last_post,  decayed_o1);
...
static inline update_state_t timing_apply_post_spike(
    ...
    if (time_since_last_pre > 0) {
        ...
        log_mini_debug("%u%u%d", 9272, time_since_last_pre,  decayed_r1);
        /* log_debug("\t\t\ttime_since_last_pret=%u, decayed_r1=%d\n",time_since_last_pre, decayed_r1);*/
        log_mini_debug("%u%u%d", 9273, time_since_last_post,  decayed_r1);
        /* log_debug("\t\t\ttime_since_last_post=%u, decayed_r1=%d\n",time_since_last_post, decayed_r1);*/

        if (time_since_last_post < time_since_last_pre) {
            log_mini_debug("%u", 9274);  /* log_debug("\t\t\tSetting trace to zero as not first pre-post pairing");*/
            decayed_r1 = 0;
        }
