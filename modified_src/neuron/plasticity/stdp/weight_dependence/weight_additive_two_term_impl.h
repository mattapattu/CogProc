// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/weight_dependence/weight_additive_two_term_impl.h
...
static inline weight_t weight_get_final(weight_state_t new_state) {
    ...
    log_mini_debug("%u%u%d%d%d%d", 9205, new_state.initial_weight,  new_state.a2_plus, new_state.a2_minus,  new_state.a3_plus,  new_state.a3_minus);
    /* log_debug("\told_weight:%u, a2+:%d, a2-:%d, a3+:%d, a3-:%d",new_state.initial_weight, new_state.a2_plus,new_state.a2_minus, new_state.a3_plus, new_state.a3_minus);*/

    log_mini_debug("%u%d%d%d%d%d", 9206, scaled_a2_plus,  scaled_a2_minus,  scaled_a3_plus, scaled_a3_minus,  new_weight);
    /* log_debug("\tscaled a2+:%d, scaled a2-:%d, scaled a3+:%d, scaled a3-:%d, new_weight:%d",scaled_a2_plus, scaled_a2_minus, scaled_a3_plus,scaled_a3_minus, new_weight);*/
