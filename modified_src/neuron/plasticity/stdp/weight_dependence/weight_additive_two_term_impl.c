// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/weight_dependence/weight_additive_two_term_impl.c
...
address_t weight_initialise(
    ...
    log_mini_debug("%u", 9189);  /* log_debug("weight_initialise: starting");*/
    log_mini_debug("%u", 9190);  /* log_debug("\tSTDP additive two-term weight dependance");*/
    ...
    if (plasticity_weight_region_data == NULL) {
        log_mini_error("%u", 9191);  /* log_error("Could not initialise weight region data");*/
        return NULL;
    }
    for (uint32_t s = 0; s < n_synapse_types; s++) {
        ...
        log_mini_debug("%u%u%d%d%d%d%d%d", 9192, s,  plasticity_weight_region_data[s].min_weight, plasticity_weight_region_data[s].max_weight, plasticity_weight_region_data[s].a2_plus, plasticity_weight_region_data[s].a2_minus, plasticity_weight_region_data[s].a3_plus, plasticity_weight_region_data[s].a3_minus);
        /* log_debug("\tSynapse type %u: Min weight:%d, Max weight:%d, A2+:%d, A2-:%d, A3+:%d, A3-:%d",s, plasticity_weight_region_data[s].min_weight,plasticity_weight_region_data[s].max_weight,plasticity_weight_region_data[s].a2_plus,plasticity_weight_region_data[s].a2_minus,plasticity_weight_region_data[s].a3_plus,plasticity_weight_region_data[s].a3_minus);*/
    ...
    log_mini_debug("%u", 9193);  /* log_debug("weight_initialise: completed successfully");*/
