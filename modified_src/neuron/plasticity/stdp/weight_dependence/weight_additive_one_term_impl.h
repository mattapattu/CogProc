// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/weight_dependence/weight_additive_one_term_impl.h
...
static inline weight_t weight_get_final(weight_state_t new_state) {
    ...
    log_mini_debug("%u%u%d%d%d%d%d", 9188, new_state.initial_weight,  new_state.a2_plus,  new_state.a2_minus, scaled_a2_plus,  scaled_a2_minus,  new_weight);
    /* log_debug("\told_weight:%u, a2+:%d, a2-:%d, scaled a2+:%d, scaled a2-:%d, new_weight:%d",new_state.initial_weight, new_state.a2_plus, new_state.a2_minus,scaled_a2_plus, scaled_a2_minus, new_weight);*/
