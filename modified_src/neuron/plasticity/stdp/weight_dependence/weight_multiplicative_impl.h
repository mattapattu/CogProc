// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/weight_dependence/weight_multiplicative_impl.h
...
static inline weight_t weight_get_final(weight_state_t new_state) {
    log_mini_debug("%u%d", 9187,  new_state.weight);  /* log_debug("\tnew_weight:%d\n", new_state.weight);*/
