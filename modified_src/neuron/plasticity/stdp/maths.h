// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/maths.h
...
static inline int16_lut *maths_copy_int16_lut(address_t *address) {
    ...
    if (lut == NULL) {
        log_mini_error("%u", 9186);
        /* log_error("Not enough space to allocate LUT.  Try reducing the timestep, the number of neurons per core, or the tau value");*/
        rt_error(RTE_SWERR);
    }
