// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/synapse_dynamics_static_impl.c
...
bool synapse_dynamics_process_plastic_synapses(
    ...
    log_mini_error("%u", 9171);  /* log_error("There should be no plastic synapses!");*/
    return false;
}
