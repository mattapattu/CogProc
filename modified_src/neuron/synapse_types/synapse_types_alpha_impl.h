// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/synapse_types/synapse_types_alpha_impl.h
...
#if 0
    log_mini_debug("%u%12.6k%12.6k%12.6k", 9117, parameters->exc.lin_buff, parameters->exc.exp_buff, parameters->exc.lin_buff * parameters->exc.exp_buff);
    /* log_debug("lin: %12.6k, exp: %12.6k, comb: %12.6k",parameters->exc.lin_buff,parameters->exc.exp_buff,parameters->exc.lin_buff * parameters->exc.exp_buff);*/
...
static inline const char *synapse_types_get_type_char(
    ...
    case INHIBITORY:
        return "I";
    default:
        log_mini_debug("%u%i", 9118,  synapse_type_index);  /* log_debug("did not recognise synapse type %i", synapse_type_index);*/
        return "?";
    }
}
...
static inline void synapse_types_print_parameters(synapse_param_t *parameters) {
    log_mini_debug("%u", 9119);  /* log_debug("-------------------------------------\n");*/
    log_mini_debug("%u%11.4k", 9120, parameters->exc.lin_buff * parameters->exc.exp_buff);
    /* log_debug("exc_response  = %11.4k\n",parameters->exc.lin_buff * parameters->exc.exp_buff);*/
    log_mini_debug("%u%11.4k", 9121, parameters->inh.lin_buff * parameters->inh.exp_buff);
