// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/synapse_types/synapse_types_dual_excitatory_exponential_impl.h
...
static inline const char *synapse_types_get_type_char(
    ...
    case INHIBITORY:
        return "I";
    default:
        log_mini_debug("%u%i", 9099,  synapse_type_index);  /* log_debug("did not recognise synapse type %i", synapse_type_index);*/
        return "?";
    }
}
...
static inline void synapse_types_print_parameters(
        synapse_param_t *parameters) {
    log_mini_info("%u%11.4k", 9100,  parameters->exc.decay);  /* log_info("exc_decay  = %11.4k\n", parameters->exc.decay);*/
    log_mini_info("%u%11.4k", 9101,  parameters->exc.init);  /* log_info("exc_init   = %11.4k\n", parameters->exc.init);*/
    log_mini_info("%u%11.4k", 9102,  parameters->exc2.decay);  /* log_info("exc2_decay = %11.4k\n", parameters->exc2.decay);*/
    log_mini_info("%u%11.4k", 9103,  parameters->exc2.init);  /* log_info("exc2_init  = %11.4k\n", parameters->exc2.init);*/
    log_mini_info("%u%11.4k", 9104,  parameters->inh.decay);  /* log_info("inh_decay  = %11.4k\n", parameters->inh.decay);*/
    log_mini_info("%u%11.4k", 9105,  parameters->inh.init);  /* log_info("inh_init   = %11.4k\n", parameters->inh.init);*/
    log_mini_info("%u%11.4k", 9106, parameters->exc.synaptic_input_value);
    /* log_info("gsyn_excitatory_initial_value = %11.4k\n",parameters->exc.synaptic_input_value);*/
    log_mini_info("%u%11.4k", 9107, parameters->exc2.synaptic_input_value);
    /* log_info("gsyn_excitatory2_initial_value = %11.4k\n",parameters->exc2.synaptic_input_value);*/
    log_mini_info("%u%11.4k", 9108, parameters->inh.synaptic_input_value);
