// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/synapse_types/synapse_types_exponential_impl.h
...
static inline const char *synapse_types_get_type_char(
    ...
    case INHIBITORY:
        return "I";
    default:
        log_mini_debug("%u%i", 9110,  synapse_type_index);  /* log_debug("did not recognise synapse type %i", synapse_type_index);*/
        return "?";
    }
}
...
static inline void synapse_types_print_parameters(
        synapse_param_t *parameters) {
    log_mini_debug("%u%R", 9111,  parameters->exc.decay);  /* log_debug("exc_decay = %R\n", parameters->exc.decay);*/
    log_mini_debug("%u%R", 9112,  parameters->exc.init);  /* log_debug("exc_init  = %R\n", parameters->exc.init);*/
    log_mini_debug("%u%R", 9113,  parameters->inh.decay);  /* log_debug("inh_decay = %R\n", parameters->inh.decay);*/
    log_mini_debug("%u%R", 9114,  parameters->inh.init);  /* log_debug("inh_init  = %R\n", parameters->inh.init);*/
    log_mini_debug("%u%11.4k", 9115, parameters->exc.synaptic_input_value);
    /* log_debug("gsyn_excitatory_initial_value = %11.4k\n",parameters->exc.synaptic_input_value);*/
    log_mini_debug("%u%11.4k", 9116, parameters->inh.synaptic_input_value);
