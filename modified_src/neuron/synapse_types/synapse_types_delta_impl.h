// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/synapse_types/synapse_types_delta_impl.h
...
static inline const char *synapse_types_get_type_char(
    ...
    case INHIBITORY:
        return "I";
    default:
        log_mini_debug("%u%i", 9109,  synapse_type_index);  /* log_debug("did not recognise synapse type %i", synapse_type_index);*/
        return "?";
    }
}
