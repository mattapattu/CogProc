// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/synapse_expander/param_generators/param_generator_normal_clipped_to_boundary.h
...
static void *param_generator_normal_clipped_boundary_initialize(
    ...
    *region = (void *) params_sdram;
    ...
    log_mini_debug("%u%k%k%k%k", 9366, obj->params.mu,  obj->params.sigma,  obj->params.low,  obj->params.high);
    /* log_debug("normal clipped to boundary mu = %k, sigma = %k, low = %k, high = %k",obj->params.mu, obj->params.sigma, obj->params.low, obj->params.high);*/
