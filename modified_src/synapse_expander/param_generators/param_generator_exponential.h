// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/synapse_expander/param_generators/param_generator_exponential.h
...
static void *param_generator_exponential_initialize(address_t *region) {
    ...
    *region = (void *) params_sdram;
    log_mini_debug("%u%k", 9364,  params->params.beta);  /* log_debug("exponential beta = %k", params->params.beta);*/
