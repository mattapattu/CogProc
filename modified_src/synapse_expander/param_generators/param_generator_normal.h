// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/synapse_expander/param_generators/param_generator_normal.h
...
static void *param_generator_normal_initialize(address_t *region) {
    ...
    *region = (void *) params_sdram;
    ...
    log_mini_debug("%u%k%k", 9363, obj->params.mu,  obj->params.sigma);
    /* log_debug("normal mu = %k, sigma = %k",obj->params.mu, obj->params.sigma);*/
