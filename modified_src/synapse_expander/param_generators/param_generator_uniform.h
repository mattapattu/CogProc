// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/synapse_expander/param_generators/param_generator_uniform.h
...
static void *param_generator_uniform_initialize(address_t *region) {
    ...
    *region = (void *) params_sdram;
    ...
    log_mini_debug("%u%k%k", 9365, params->params.low,  params->params.high);
    /* log_debug("Uniform low = %k, high = %k",params->params.low, params->params.high);*/
