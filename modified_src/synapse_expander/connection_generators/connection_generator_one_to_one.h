// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/synapse_expander/connection_generators/connection_generator_one_to_one.h
...
static void *connection_generator_one_to_one_initialise(address_t *region) {
    ...
    *region = (void *) params_sdram;
    ...
    log_mini_debug("%u%u%u%u%u", 9400, params->pre_lo,  params->pre_hi,  params->post_lo,  params->post_hi);
    /* log_debug("One to one connector, pre_lo = %u, pre_hi = %u, post_lo = %u, post_hi = %u",params->pre_lo, params->pre_hi, params->post_lo, params->post_hi);*/
...
static uint32_t connection_generator_one_to_one_generate(
    ...
    log_mini_debug("%u%u", 9401,  pre_neuron_index);  /* log_debug("pre_neuron_index %u", pre_neuron_index);*/
