// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/synapse_expander/connection_generators/connection_generator_fixed_prob.h
...
static void *connection_generator_fixed_prob_initialise(address_t *region) {
    ...
    *region = (void *) params_sdram;
    ...
    log_mini_debug("%u%u%u%u%u%u%k", 9385, obj->params.pre_lo,  obj->params.pre_hi,  obj->params.post_lo,  obj->params.post_hi, obj->params.allow_self_connections, (accum) obj->params.probability);
    /* log_debug("Fixed Probability Connector, pre_lo = %u, pre_hi = %u, post_lo = %u, post_hi = %u, allow self connections = %u, probability = %k",obj->params.pre_lo, obj->params.pre_hi, obj->params.post_lo, obj->params.post_hi,obj->params.allow_self_connections,(accum) obj->params.probability);*/
...
static uint32_t connection_generator_fixed_prob_generate(
    ...
    for (uint32_t i = 0; i < post_slice_count; i++) {
        ...
        if ((value <= obj->params.probability) &&
            ...
            log_mini_warning("%u", 9386);  /* log_warning("Row overflow");*/
        }
    }
