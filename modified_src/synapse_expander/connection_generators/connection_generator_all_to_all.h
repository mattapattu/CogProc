// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/synapse_expander/connection_generators/connection_generator_all_to_all.h
...
static void *connection_generator_all_to_all_initialise(address_t *region) {
    ...
    *region = (void *) params_sdram;
    ...
    log_mini_debug("%u%u%u%u%u%u", 9387, params->pre_lo,  params->pre_hi,  params->post_lo,  params->post_hi, params->allow_self_connections);
    /* log_debug("All to all connector, pre_lo = %u, pre_hi = %u, post_lo = %u, post_hi = %u, allow_self_connections = %u",params->pre_lo, params->pre_hi, params->post_lo, params->post_hi,params->allow_self_connections);*/
...
static uint32_t connection_generator_all_to_all_generate(
    ...
    log_mini_debug("%u%u", 9388,  pre_neuron_index);  /* log_debug("Generating for %u", pre_neuron_index);*/
    ...
    for (uint32_t i = 0; i < post_slice_count; i++) {
        ...
        if (!obj->allow_self_connections &&
            ...
            log_mini_debug("%u%u", 9389,  post_slice_start + i);  /* log_debug("Not generating for post %u", post_slice_start + i);*/
            continue;
        }
