// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/synapse_expander/connection_generators/connection_generator_kernel.h
...
static void *connection_generator_kernel_initialise(address_t *region) {
    ...
    *region = (void *) params_sdram;
    ...
    log_mini_debug("%u%u%u", 9390, obj->kernelWidth,  obj->kernelHeight);
    /* log_debug("Kernel connector, m_kernelWidth, m_kernelHeight = %u %u",obj->kernelWidth, obj->kernelHeight);*/
...
static uint32_t connection_generator_kernel_generate(
    ...
    log_mini_debug("%u%u", 9391,  pre_neuron_index);  /* log_debug("Generating for %u", pre_neuron_index);*/
